...
locales: {
    '/': {
      ...
      title: 'MingDao Administrator Guide',
      description: 'You can get the Installation of Image,Administrator,Configuration of the MingDao from this documentation.'
    },
    '/zh/': {
      lang: 'zh-CN',
      title: 'MingDao 管理员手册',
